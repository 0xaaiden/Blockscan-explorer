...
import ChartVolumeOT from "@/charts/ChartVolumeOT";
export default function SearchResults(props) {


  const groupByAddress = helpers.groupByAddress;
  const TxCountByAddress = helpers.TxCountByAddress;

  useEffect(() => {
    console.log("groupByAddress", groupByAddress(props.result.result));
    console.log("TxCountByAddress", TxCountByAddress(props.result.result));
  }, []);
